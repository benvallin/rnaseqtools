...
#'
tidy_summaryZlmFit <- function(input, coef, cnt_scale = "log2", level = 0.95, gene_id = "ensembl_gene_id") {
  ...
  output[, c(gene_id, "log2FoldChange", "lfcSE", "pvalue", "padj", "sign_log2fc_times_minus_log10pvalue")] %>%
